...
// [Unit]
// Description=Cloudflare Tunnel with Token
// After=network.target

// [Service]
// ExecStart=/usr/local/bin/cloudflared tunnel --no-autoupdate run --token eyJhIjoiMThjNzFiNWQ5ODlhODYwYjViMTVkMGRhMTg1MzIxM2IiLCJ0IjoiMDg5ODdiNDktMjY1OS00NzZlLWJhNmUtMjkxNjZlZDY0MDRjIiwicyI6Ik9HRmhNbVUwTXpVdFpEQXdaQzAwTjJJeUxUZ3haRGN0TURnNE1EYzJNR1EwWWpVMiJ9
