    ...
    return (
        <div className="w-full">
            <div className="w-full -mx-2 -my-2 pl-[1%] pr-[1%] flex pt-[20px] text-blue-500 bg-off-black text-center place-content-between pb-4"> {/* you can write negative margins by putting the - before them*/}
                <h1 className="bg-bg-dark-grey border-2 rounded-md border-blue-500 p-3 min-h-[20%] max-h-[80%] w-[20%] text-[20px]">Games</h1>
                <h1 className="bg-bg-dark-grey border-2 rounded-md border-blue-500 p-3 min-h-[20%] max-h-[80%] w-[20%] text-[20px]">Art</h1>
                <h1 className="bg-bg-dark-grey border-2 rounded-md border-blue-500 p-3 min-h-[20%] max-h-[80%] w-[20%] text-[20px]">Models</h1>
            </div>
            <div className="mt-5">
