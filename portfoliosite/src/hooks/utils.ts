...
export const useUtils = () => {
  ...
  const isTrash =
    ...
    location.pathname.includes("/drive/folder-trash") ||
    location.pathname.includes("/drive/search-trash");

  const isMedia =
    location.pathname === "/drive/media" ||
    location.pathname.includes("/drive/search-media");

  const isSettings = location.pathname === "/drive/settings";

  const isHomeFolder = location.pathname.includes("/drive/folder/");

  const isSearch = location.pathname.includes("/drive/search/");
